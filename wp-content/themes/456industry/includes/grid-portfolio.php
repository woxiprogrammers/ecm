	...
	<?php }?>
            ...
            <div class="box-caption <?php if(!has_post_thumbnail()&&!$post_header_image_thumbnail&&!$video){?>no-caret<?php }?>">
                ...
                <div class="box-caption-bottom">
                    ...
                    <div class="mb_social">
                        <a href="http://www.facebook.com/sharer/sharer.php?s=100&p[url]=<?php the_permalink();?>&p[images][0]=<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'medium' ); echo $image[0];?>&p[title]=<?php the_title();?>&p[summary]=<?php echo  wp_strip_all_tags(lpd_excerpt(25))?>" class="fb-icon"></a>
                        ...
                        <a href="http://pinterest.com/pin/create/button/?url=<?php the_permalink();?>&media=<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), 'medium' ); echo $image[0];?>&description=<?php echo  wp_strip_all_tags(lpd_excerpt(25))?>" class="pi-icon"></a>
                    </div>
                </div> 
                <?php }?>   
            </div>
