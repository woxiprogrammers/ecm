...
function lpd_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'   				=> 'http://downloads.wordpress.org/plugin/contact-form-7.4.4.1.zip', // The plugin source
		...
		array(
			'name'     				=> 'Meet the Team', // The plugin name
		...
		array(
			...
			'source'   				=> get_stylesheet_directory() . '/plugins/envato-market.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
